...
export default () => (
  <Card className="help">
    ...
    <pre>
      ...
      - Только в статусе можно изменять текущее здоровье и защиту<br/>
      - Кликом на конечность она повреждается либо лечится<br/>
      - При выходе со страницы статуса изменения сохраняются<br/>
    ...
    <pre>
      ...
      - Первый перк, сообщения или предмет не подгружаются автоматически<br/>
      - <br/>
    </pre>

    <h1>Todo</h1>
    <pre>
      - Отрефакторить повторяющиеся код в UID страницах
