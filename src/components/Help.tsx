...
export default () => (
  <Card className="help">
    ...
    <h1>Todo</h1>
    <pre>
      - В чужих харках персонажа сделать инпуты readOnly вместо disabled<br/>
      - Вырезать персонажа в БД в отедльную коллекцию. Удалить base-users<br/>
      - Страница квенты. Квента в гугл доках<br/>
      - Личные записи (видны админу и владельцу)<br/>
      - Сделать переключатель личных видимости записей<br/>
      ...
      - Переименовать чат на логи<br/>
      - Добавить логи для каждого действия<br/>
      - Спрятать не нужные меню (предметы, ивентарь, чат)<br/>
