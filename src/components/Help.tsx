...
export default () => (
  <Card className="help">
    ...
    <pre>
      ...
      - Запретить использовать неиспользуемое (оружие, броня, мусор, записки, ключи)<br/>
      - Передавание предметов<br/>
      - Отрефакторить ItemCreator на форму<br/>
      - Добавить в настройки демонстрацию админки. Админ может включать/выключать, но не себе<br/>
      - При показании, использовании и выбрасывании предмета редиретить в чат<br/>
      - Дать возможность проверять чужой инвентарь (без редактирования)<br/>
      - Запретить брать не подтвержденные предметы<br/>
      - Инпут чата сместился горизонтально (1920 ширина)<br/>
      - Подбирание предмета с подтверждением<br/>
      - В предмете не выводить кол-во, если он меньше двух<br/>
      - <br/>
    </pre>
